...
cloudant_username = '6994e196-3086-40e9-a850-d642240c6ae5-bluemix'
cloudant_api_key = 'V3-E4_mAx_jjzARpgF7MXq9s5-CSjD-XMzfuevZUg8S9'
cloudant_url = 'https://6994e196-3086-40e9-a850-d642240c6ae5-bluemix.cloudantnosqldb.appdomain.cloud'
...
def post_review():
    ...
    review_data = json.loads(request.json)['review']
    print(review_data)
    # Validate that the required fields are present in the review data
    required_fields = ['id', 'name', 'dealership', 'review', 'purchase', 'purchase_date', 'car_model', 'car_year']
